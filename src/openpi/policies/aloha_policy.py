...
class AlohaInputs(transforms.DataTransformFn):
    ...
    def __call__(self, data: dict) -> dict:
        ...
        if "rtc_obs" in data:
            ...
            inputs["rtc_obs"]["prev_state"] = _decode_state(inputs["rtc_obs"]["prev_state"], adapt_to_pi=self.adapt_to_pi)
            inputs["rtc_obs"]["prev_action"] = _encode_actions_inv(inputs["rtc_obs"]["prev_action"], adapt_to_pi=self.adapt_to_pi)
